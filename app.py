...
# ----------------- PROJECTOR SCREEN -----------------
    ...
    with text_col:
        if game_status == "lobby":
            st.markdown("<h2 style='font-size: 32px; font-weight: 800; line-height: 1.2; margin-bottom: 0px;'>Wesley & Angel’s Photo Booth Challenge! 📸</h2>", unsafe_allow_html=True)
            ...
            st.markdown("<h2 style='font-size: 40px; font-weight: 800; line-height: 1.0; margin-bottom: 0px;'>Wesley & Angel’s Photo Booth Challenge! ⏳</h2>", unsafe_allow_html=True)
